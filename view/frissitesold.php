        ...
        <form class="mt-8 space-y-6" action="../controller/frissites.php" method="POST" id="frissites-form">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <div>
                    ...
                    <input type = "file" name= "profilkep" id="profilkep" class="form-input appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm"></input>
                </div>
